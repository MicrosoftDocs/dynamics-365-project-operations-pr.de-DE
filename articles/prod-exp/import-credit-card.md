...
description: Dieser Artikel erklärt, wie Sie aufwandsbezogene Kreditkartentransaktionen importieren und pflegen können. Diese Transaktionen können so eingerichtet werden, dass sie automatisch nach einem wiederkehrenden Zeitplan importiert werden, oder sie können bei Bedarf manuell importiert werden.
author: KimANelson
ms.date: 01/12/2018
ms.topic: article
ms.prod: ''
