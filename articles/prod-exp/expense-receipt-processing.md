...
description: Dieser Artikel enthält Informationen über die Verarbeitung optischer Zeichenerkennung (OCR) für Quittungen. Diese Funktion wurde entwickelt, um die Benutzerfreundlichkeit bei der Erstellung von Spesenabrechnungen in Microsoft Dynamics 365 Finance zu verbessern.
author: stsporen
ms.date: 05/14/2020
ms.topic: article
ms.prod: ''
