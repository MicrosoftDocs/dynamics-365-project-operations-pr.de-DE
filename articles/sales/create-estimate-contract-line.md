...
---
# <a name="estimate-a-projectbased-contract-line"></a>Eine projektbasierte Vertragszeile kalkulieren
...
## <a name="create-an-estimate-directly-on-a-projectbased-contract-line"></a>Eine Schätzung direkt für eine projektbasierte Vertragszeile erstellen
...
| **Ressourcenzuordnungsunternehmen** | **Schnellertellung** | Das Beschaffungsunternehmen oder die juristische Person, die diese Kosten verursachen und die Ressource bereitstellen, um daran zu arbeiten. | In diesem Feld werden standardmäßig die zugehörigen Vertragszeilendetails für Kosten verwendet, die automatisch erstellt werden. Dieses Feld wird auch zum Abrufen von Einstandspreisen verwendet. |
