...
- **\<EntitiesToEnableScheduling\>** gibt an, welche Entitäten für die Buchung in der Microsoft Dynamics-Planung aktiviert werden sollen (alias Universal Resource Scheduling).
