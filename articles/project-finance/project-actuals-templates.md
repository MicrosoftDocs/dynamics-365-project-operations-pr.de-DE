...
- Wenn Sie eine neue Vorlage erstellen, müssen Sie die Spalte hinzufügen, um die Intercompany-Zeit und -Kosten zu unterstützen. Wählen Sie **Bedingte Spalte hinzufügen** aus, und geben Sie einen Namen für die neue Spalte ein wie **LegalEntity**. Geben Sie folgende Bedingung für die Spalte ein: wenn **msdyn\_contractorganizationalunitid.msdyn\_name** \<organizational unit\> ist, dann \<enter the legal entity\>; andernfalls null.
