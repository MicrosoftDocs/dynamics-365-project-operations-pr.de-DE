...
description: Dieser Artikel enthält Beispiele für die Projektverträge, die Sie für verschiedene Arten von Projekten und Finanzierungsquellen erstellen können, sowie für die Verwaltung von Verträgen und die Rechnungsstellung von Projektkunden.
author: Yowelle
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
