...
description: Dieser Artikel enthält Informationen über den mobilen Arbeitsbereich für die Zeiterfassung in Project. In diesem Arbeitsbereich können Benutzer mithilfe ihrem mobilen Gerät ein Projekt eingeben und Zeit sparen.
author: Yowelle
ms.date: 12/01/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8919537"
---
# <a name="project-time-entry-mobile-workspace"></a>Mobiler Arbeitsbereich für die Projektzeiteingabe

[!include [banner](../includes/banner.md)]

Dieser Artikel enthält Informationen über den mobilen Arbeitsbereich **Projektzeiterfassung**. In diesem Arbeitsbereich können Benutzer mithilfe ihrem mobilen Gerät ein Projekt eingeben und Zeit sparen.
